		...
		function() {
			...
			jQuery( '#hub-gr-props-form' ).submit(
				...
				if ( oauth_status ) {
					...
					await saveUpdates( { 'hubwoo-groups-created': allCreatedGroups, 'hubwoo-properties-created': allCreatedProperties, 'hubwoo_fields_setup_completed': 1, 'hubwoo_pro_setup_completed': 1, 'hubwoo_plugin_version': '1.4.5' } );
					await runEcommSetup();
