                                    ...
                                    <li class="jobsearch-column-6">
                                        ...
                                        <div class="jobsearch-employer-resumes-wrap">
                                            ...
                                            <figure>
                                                ...
                                                <figcaption>
                                                    ...
                                                    if ($candidate_jobtitle != '') {
                                                        ?>
                                                        <span class="jobsearch-resumes-subtitle"><?php echo apply_filters('jobsearch_cand_jobtitle_indisplay', $candidate_jobtitle, $candidate_id) ?></span>
                                                        <?php
                                                    }
                                                    ?>
                                                    <ul>
                                            ...
                                            <ul class="jobsearch-resumes-options">
                                                ...
                                                <?php if ($get_user_linkedin_url != '' && !$cand_profile_restrict::cand_field_is_locked('socialicons_defields')) { ?>
