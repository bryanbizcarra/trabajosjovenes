        ...
        <div class="jobsearch-employer-box-section">
            ...
            $args = array(
                ...
                'meta_query' => apply_filters('jobsearch_emp_dash_pkgs_list_tab_mquery', array(
                    ...
                    array(
                        'key' => 'package_type',
                        'value' => apply_filters('jobsearch_emp_dash_pkg_types_in_query', array('job', 'featured_jobs', 'emp_allin_one', 'cv', 'promote_profile', 'urgent_pkg', 'employer_profile', 'invites_cred')),
                        'compare' => 'IN',
                    ),
                    array(
                                    ...
                                    <table class="packge-detail-table">
                                        <tbody>
                                            ...
                                            if ($pkg_type == 'job' || $pkg_type == 'featured_jobs' || $pkg_type == 'emp_allin_one' || $pkg_type == 'employer_profile' || $pkg_type == 'invites_cred') {
                                                ?>
                                                <tr class="pakcge-itm-stats">
                                                    <td class="pakcge-one-hding"><?php esc_html_e('Number of Invites', 'wp-jobsearch'); ?></td>
                                                    <?php
                                                    if ($unlimited_num_invites == 'yes') {
                                                        ?>
                                                        <td colspan="3"><?php esc_html_e('Unlimited', 'wp-jobsearch') ?></td>
                                                        ...
                                                        ?>
                                                        <td><?php printf(__('Total: %s', 'wp-jobsearch'), $total_invites) ?></td>
                                                        <td><?php printf(__('Used: %s', 'wp-jobsearch'), $used_invites) ?></td>
                                                        <td><?php printf(__('Remaining: %s', 'wp-jobsearch'), $remaining_invites) ?></td>
                                                        <?php
                                                    }
                                                    ?>
                                                </tr>
