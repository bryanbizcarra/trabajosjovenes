    ...
    <ul class="jobsearch-row">
        ...
        if ($candidate_loop_obj->have_posts()) {
            ...
            foreach ($candidate_loop_obj->posts as $candidate_id) {
                ...
                if ($jobsearch_candidate_jobtitle != '' && !is_array($jobsearch_candidate_jobtitle)) {
                ...
                if ($candidate_skills == 'on') {
                    ...
                    $profile_status_txt = esc_html__('Basic', 'wp-jobsearch');
                    if ($overall_candidate_skills <= 25 && $low_skills_clr != '') {
                        $final_color = 'style="color: ' . $low_skills_clr . ';"';
                        $profile_status_txt = esc_html__('Low', 'wp-jobsearch');
                        ...
                        $profile_status_txt = esc_html__('Professional', 'wp-jobsearch');
                    } else if ($overall_candidate_skills > 75 && $comp_skills_clr != '') {
                        $final_color = 'style="color: ' . $comp_skills_clr . ';"';
                        $profile_status_txt = esc_html__('Expert', 'wp-jobsearch');
                    }
                }
                ?>
                        ...
                        <div class="jobsearch-candidate-default-text">
                            <div class="jobsearch-candidate-default-left">
                                ...
                                <h2 class="jobsearch-pst-title">
                                    ...
                                    if ($candidate_skills == 'on') {
                                        ?>
                                        <i class="jobsearch-icon jobsearch-check-mark cand-profile-status-tooltip" title="<?php echo ($profile_status_txt) ?>" <?php echo($final_color) ?>></i>
                                        <?php
                                    }
                                    ?>
                                </h2>
