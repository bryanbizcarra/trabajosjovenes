            ...
            <div class="jobsearch-plugin-default-container" <?php echo($plugin_default_view_with_str); ?>>
                <div class="jobsearch-row">
                            ...
                            <figcaption>
                                ...
                                if (!empty($employer_social_mlinks) || ($emp_alow_fb_smm == 'on' || $emp_alow_twt_smm == 'on' || $emp_alow_gplus_smm == 'on' || $emp_alow_linkd_smm == 'on' || $emp_alow_dribbb_smm == 'on')) {
                                    ...
                                    <ul class="jobsearch-jobdetail-media jobsearch-add-space">
                                        ...
                                        $empdet_social_html = ob_get_clean();
                                        echo apply_filters('jobsearch_empdetail_common_social_links_html', $empdet_social_html, $employer_id);
                    ...
                    <div class="jobsearch-column-8 jobsearch-typo-wrap">
                        ...
                        <div class="jobsearch-jobdetail-content jobsearch-employerdetail-content">
                            ...
                            if ($emp_foundate_switch != 'off' && $found_date_str != '') {
                                ...
                                <li class="jobsearch-column-4">
                                    ...
                                    <div class="jobsearch-services-text"><?php esc_html_e('Founded Date', 'wp-jobsearch') ?>
                                    ...
                                    <ul id="members-holder-<?php echo absint($rand_num_ul) ?>" class="jobsearch-row">
                                        ...
                                        foreach ($exfield_list as $exfield) {
                                            ...
                                            <li class="jobsearch-column-4">
                                                ...
                                                <figure>
                                                    <?php if ($team_imagefield_imgid > 0 && $team_picture_show == 'on') { ?>
                                                ...
                                                if ($team_facebookfield_val != '' || $team_googlefield_val != '' || $team_twitterfield_val != '' || $team_linkedinfield_val != '') {
                                                    ...
                                                    <ul class="jobsearch-social-icons">
                                                        <?php if ($team_facebookfield_val != '') {
                                                            ...
                                                            <?php
                                                            $socialink_html = ob_get_clean();
                                                            echo apply_filters('jobsearch_empdetail_team_socialink_facebook_html', $socialink_html, $team_facebookfield_val);
                                                        }
                                                        if ($team_googlefield_val != '') {
                                                            ...
                                                            <?php
                                                            $socialink_html = ob_get_clean();
                                                            echo apply_filters('jobsearch_empdetail_team_socialink_google_html', $socialink_html, $team_googlefield_val);
                                                        }
                                                        if ($team_twitterfield_val != '') {
                                                            ...
                                                            <?php
                                                            $socialink_html = ob_get_clean();
                                                            echo apply_filters('jobsearch_empdetail_team_socialink_twitter_html', $socialink_html, $team_twitterfield_val);
                                                        }
                                                        if ($team_linkedinfield_val != '') {
                                                            ...
                                                            <?php
                                                            $socialink_html = ob_get_clean();
                                                            echo apply_filters('jobsearch_empdetail_team_socialink_linkedin_html', $socialink_html, $team_linkedinfield_val);
                                                        }
                                                        ?>
                                                    </ul>
                                                    <?php
                        ...
                        do_action('jobsearch_empdetail_after_team_html', $employer_id);
                        ...
                        echo apply_filters('jobsearch_empdetail_reviews_html', $reviews_html, $employer_id, 'view1');
                        ...
                        $activ_jobs_fhtml = ob_get_clean();
                        echo apply_filters('jobsearch_empdetail_active_jobs_full_html', $activ_jobs_fhtml, $employer_id);
                        
                        do_action('jobsearch_empdetail_after_activejobs', $employer_id, 'view1');
                        ?>
                    </div>
                    <?php
                    ob_start();
                    ...
                    if ($emp_det_contact_form != 'off' && isset($user_obj->user_email)) {
                        ...
                        <div class="jobsearch_side_box jobsearch_box_contact_form">
                            ...
                            <?php
                            $form_title_html = ob_get_clean();
                            echo apply_filters('jobsearch_empdetail_contactform_title', $form_title_html);
                            ?>
                            <form autocomplete="off" id="ct-form-<?php echo absint($cnt_counter) ?>" data-uid="<?php echo absint($user_id) ?>" method="post">
                                <ul>
                                    <li>
                    ...
                    do_action('jobsearch_emp_detail_sidebar_end', $employer_id, 'view1');
                    $sidbar_html = ob_get_clean();
                    if ($sidbar_html != '') {
                        ?>
                        <aside class="jobsearch-column-4 jobsearch-typo-wrap">
                            <?php echo ($sidbar_html) ?>
                        </aside>
                        <?php
                    }
                    ?>
