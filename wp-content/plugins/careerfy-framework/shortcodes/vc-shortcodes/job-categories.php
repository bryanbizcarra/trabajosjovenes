...
function careerfy_job_categories_shortcode($atts)
{
    ...
    if (class_exists('JobSearch_plugin')) {
        ...
        if ($order_by == 'id') {
            ...
            if (function_exists('icl_object_id')) {
                $cats_query .= " AND icl_trans.element_type='tax_sector'";
        ...
        <div id="jobsearch-findby-sectors" class="<?php echo($cats_class) ?>" data-view="<?php echo($cats_view) ?>">
            ...
            <div class="row jobsearch-sects-allcon">
                <?php } ?>
                        ...
                        <div class="careerfy-top-sectors-category">
                            <ul>
                                ...
                                <ul class="jobsearch-sects-allcon<?php echo $cats_view != 'view4' ? $row_class : '' ?>">
                                    ...
                                    jobsearch_job_sectors_list_comon($atts, $get_db_terms);
...
if (!function_exists('jobsearch_job_sectors_list_comon')) {
    function jobsearch_job_sectors_list_comon($atts, $get_db_terms) {
        global $wpdb, $jobsearch_plugin_options, $jobsearch_shortcode_jobs_frontend, $sitepress;
        extract(shortcode_atts(array(
            'cats_view' => '',
            'num_cats' => '',
