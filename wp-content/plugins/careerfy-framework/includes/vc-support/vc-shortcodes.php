...
function careerfy_vc_advance_search()
{
    ...
    $adv_srch_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Suggestions For", "careerfy-frame"),
        'param_name' => 'autofill_sugg_type',
        'value' => array(
            esc_html__("Job", "careerfy-frame") => 'job',
            esc_html__("Candidate", "careerfy-frame") => 'candidate',
            esc_html__("Employer", "careerfy-frame") => 'employer',
        ),
        'description' => '',
        'dependency' => array(
            'element' => 'autofill_keyword',
            'value' => array('yes')
        ),
        'group' => esc_html__("Fields Settings", "careerfy-frame"),
    );
    ...
    $attributes = array(
        ...
        "params" => array(
            ...
            array(
                ...
                'dependency' => array(
                    'element' => 'cats_view',
                    'value' => array('view1', 'view2', 'view3', 'view4', 'view5', 'view6', 'view7', 'view9', 'view10', 'slider')
                ),
                'description' => ''
            ),
            array(
...
function careerfy_vc_jobs_listing()
{
    ...
    $job_listsh_parms[] = array(
        ...
        'value' => array(
            ...
            esc_html__("Style 10", "careerfy-frame") => 'view-listing-10',
        ),
...
//        }
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Location Filter Sort by", "careerfy-frame"),
        'param_name' => 'job_locfilters_sortby',
        'value' => array(
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Date Posted Filter Sort by", "careerfy-frame"),
        'param_name' => 'job_datefilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Job Type Filter Sort by", "careerfy-frame"),
        'param_name' => 'job_typefilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Sector Filter Sort by", "careerfy-frame"),
        'param_name' => 'job_sectorfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Skills", "careerfy-frame"),
        'param_name' => 'job_filters_skill',
        'value' => array(
            esc_html__("Yes", "careerfy-frame") => 'yes',
            esc_html__("No", "careerfy-frame") => 'no',
        ),
        'description' => esc_html__("Jobs searching filters 'Skills' switch.", "careerfy-frame"),
        'group' => esc_html__("Filters Settings", "careerfy-frame"),
    );
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Skills Filter Sort by", "careerfy-frame"),
        'param_name' => 'job_skillfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $job_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Skills Filter Collapse", "careerfy-frame"),
        'param_name' => 'job_filters_skill_collapse',
        'value' => array(
            esc_html__("No", "careerfy-frame") => 'no',
            esc_html__("Yes", "careerfy-frame") => 'yes',
        ),
...
function careerfy_vc_employer_listing()
{
    ...
    $emp_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Location Filters Sort by", "careerfy-frame"),
        'param_name' => 'employer_locfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $emp_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Date Posted Filters Sort by", "careerfy-frame"),
        'param_name' => 'employer_datefilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $emp_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Sectors Filters Sort by", "careerfy-frame"),
        'param_name' => 'employer_sectorfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $emp_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Team Size Filters Sort by", "careerfy-frame"),
        'param_name' => 'employer_teamfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
...
function careerfy_vc_candidate_listing()
{
    ...
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Locations", "careerfy-frame"),
        'param_name' => 'cand_filters_loc',
        'value' => array(
            esc_html__("Yes", "careerfy-frame") => 'yes',
            esc_html__("No", "careerfy-frame") => 'no',
        ),
        'description' => esc_html__("Candidates searching filters 'Location' switch.", "careerfy-frame"),
        'group' => esc_html__("Filters Settings", "careerfy-frame"),
    );
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Locations Filters Sort by", "careerfy-frame"),
        'param_name' => 'candidate_locfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Locations Filter Collapse", "careerfy-frame"),
        'param_name' => 'cand_filters_loc_collapse',
        'value' => array(
            esc_html__("No", "careerfy-frame") => 'no',
            esc_html__("Yes", "careerfy-frame") => 'yes',
        ),
    ...
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Locations Filter Style", "careerfy-frame"),
        'param_name' => 'cand_filters_loc_view',
        'value' => array(
            esc_html__("Checkbox List", "careerfy-frame") => 'checkboxes',
            esc_html__("Dropdown Fields", "careerfy-frame") => 'dropdowns',
            esc_html__("Input Field", "careerfy-frame") => 'input',
    ...
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Date Posted Filters Sort by", "careerfy-frame"),
        'param_name' => 'candidate_datefilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
    ...
    $cand_listsh_parms[] = array(
        'type' => 'dropdown',
        'heading' => esc_html__("Sectors Filters Sort by", "careerfy-frame"),
        'param_name' => 'candidate_sectorfilters_sortby',
        'value' => array(
            esc_html__("Default", "careerfy-frame") => 'default',
            esc_html__("Ascending", "careerfy-frame") => 'asc',
            esc_html__("Descending", "careerfy-frame") => 'desc',
...
function careerfy_vc_counters_shortcode()
{
    ...
    $attributes = array(
        ...
        "params" => array(
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Counter Type", "careerfy-frame"),
                "param_name" => "count_type",
                'value' => array(
                    esc_html__("Default", "careerfy-frame") => 'default',
                    esc_html__("For Jobs", "careerfy-frame") => 'jobs',
                    esc_html__("For Candidates", "careerfy-frame") => 'candidates',
                    esc_html__("For Employers", "careerfy-frame") => 'employers',
                    esc_html__("For Applicants", "careerfy-frame") => 'applicants',
                ),
                "description" => ''
            ),
            array(
