    ...
    class Careerfy_Newsletter extends WP_Widget {
        ...
        function widget($args, $instance) {
            ...
            if (!empty($mailchimp_list) && '' != $mailchimp_api_key) { ?>
                ...
                <form autocomplete="off" action="javascript:careerfy_mailchimp_submit<?php echo intval($counter); ?>('<?php echo esc_js($counter); ?>','<?php echo admin_url('admin-ajax.php'); ?>')" id="mcform_<?php echo intval($counter); ?>" method="post">
                    <?php
