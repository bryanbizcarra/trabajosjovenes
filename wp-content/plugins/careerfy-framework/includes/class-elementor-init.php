...
class CareerfyElementorPlugin
{
    ...
    private function include_widgets_files()
    {
        ...
        if (class_exists('JobSearch_plugin')) {
            ...
            require_once(__DIR__ . '/elementor-widget/wp-jobsearch-elements/explore-jobs-tabs.php');
        }
        /*
         *
        ...
        require_once(__DIR__ . '/elementor-widget/careerfy-framework-elements/breadcrumb.php');
    }
    ...
    public function register_widgets()
    {
        ...
        * */
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Explore_Jobs_Tabs());
    }
}
