    ...
    protected function render()
    {
        ...
        if ($view == 'style1') { ?>
            <div class="careerfy-eighteen-newslatter">
                <form autocomplete="off" action="javascript:careerfy_mailchimp_submit<?php echo intval($counter); ?>('<?php echo esc_js($counter); ?>','<?php echo admin_url('admin-ajax.php'); ?>')"
                ...
                <div class="col-md-7">
                    <div class="careerfy-twenty-search-tabs">
                        ...
                        <div class="tab-content">
                            <form autocomplete="off" method="post" id="registration-form-<?php echo absint($rand_numb) ?>"
