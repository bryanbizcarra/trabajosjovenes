                            ...
                            foreach ($ids_arr as $candidate_id) {
                                ...
                                <div>
                                    <figure>
                                        ...
                                        <a href="<?php echo get_permalink($candidate_id); ?>" class="careerfy-candidate-grid-thumb"><img src="<?php echo ($post_thumbnail_src) ?>" alt=""> <?php if ($candidate_skills == 'on') { ?><span class="careerfy-candidate-grid-status" <?php echo ($final_color) ?>></span><?php } ?></a>
                                        <?php } ?>
                                        <figcaption>
                                            <h2>
                    ...
                    <ul class="jobs-scroll-wrap scroll" id="featured-scroll-<?php echo ($rand_id); ?>">
                        ...
                        if (!empty($ids_arr)) {
                            ...
                            foreach ($ids_arr as $job_id) {
                                ...
                                <?php
                                $itm_html = ob_get_clean();
                                echo apply_filters('jobsearch_feature_slidr_job_listing_item_html', $itm_html, $job_id);
                            }
                        } else {
                            echo '<li>
