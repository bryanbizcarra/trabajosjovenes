    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'view21' => __('Style 21', 'careerfy-frame'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'condition' => [
                    'view' => array('view1', 'view2', 'view3', 'view5', 'view6', 'view7', 'view9', 'view11', 'view12', 'view13', 'view15', 'view16', 'view17', 'view21')
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'view' => array('view1', 'view2', 'view3', 'view5', 'view6', 'view7', 'view9', 'view11', 'view12', 'view13', 'view15', 'view16', 'view18', 'view17', 'view21')
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => $all_page,
                'condition' => [
                    'view' => array('view1', 'view2', 'view3', 'view4', 'view5', 'view6', 'view7', 'view8', 'view9', 'view11', 'view10', 'view12', 'view13', 'view14', 'view15', 'view16', 'view21')
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => $all_page,
                'condition' => [
                    'view' => array('view1', 'view2', 'view3', 'view4', 'view5', 'view6', 'view7', 'view8', 'view9', 'view11', 'view10', 'view12', 'view14', 'view15', 'view16', 'view21')
                ]
            ]
        );
        ...
        $this->add_control(
            'autofill_sugg_type',
            [
                'label' => __('Suggestions For', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'no',
                'options' => [
                    'job' => __('Job', 'careerfy-frame'),
                    'candidate' => __('Candidate', 'careerfy-frame'),
                    'employer' => __('Employer', 'careerfy-frame'),
                ],
                'condition' => [
                    'autofill_keyword' => array('yes')
                ]
            ]
        );
        $this->add_control(
    ...
    protected function render()
    {
        ...
        if (class_exists('JobSearch_plugin')) {
            ...
            if ($view == 'view21') {
                ...
                ?>
                <!-- Main Section -->
                <div class="careerfy-main-section careerfy-search-twentyone-full">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="careerfy-search-twentyone">
                                <?php
                                if ($srch_title != '' || $srch_desc != '') {
                                    ?>
                                    <div class="advserch-title-desc">
                                        <?php
                                        if ($srch_title != '') { ?>
                                        ...
                                        if ($srch_desc != '') {
                                            ?>
                                            <p class="srch-desc" <?php echo($adv_search_paragraph_color) ?>><?php echo ($srch_desc) ?></p>
                                            <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                if ($keyword_field == 'show' || $location_field == 'show' || $category_field == 'show' && $sectors_enable_switch == 'on') {
                                    ?>
                                    <form autocomplete="off" class="careerfy-banner-search-twentyone <?php echo($without_keyword_class) ?> <?php echo($without_sectr_class) ?> <?php echo($without_loc_class) ?> <?php echo($design_css_class) ?>"
                                          method="get"
                                        ...
                                        <div class="careerfy-search-twentyone-grid">
                                            ...
                                            if ($keyword_field == 'show') {
                                                ...
                                                <div class="advserch-field">
                                                    <div class="<?php echo($autofill_keyword == 'yes' ? 'jobsearch-sugges-search' : '') ?> advsrch-keyword-field">
                                                        <i class="careerfy-icon careerfy-geo-location-fill input-icon"></i>
                                                        <input placeholder="<?php esc_html_e('Job Title, Keywords, or Phrase', 'careerfy-frame') ?>" name="search_title" data-type="<?php echo ($autofill_sugg_type) ?>" type="text">
                                                    ...
                                                    <div class="jobsearch_searchloc_div">
                                                        ...
                                                        if ($top_search_radius == 'yes' && $radius_field == 'show' && $auto_geo_location == 'no') { ?>
                                                            <a href="javascript:void(0);" class="geolction-btn"><i
                                                                        class="careerfy-icon careerfy-pin input-icon"></i></a>
                                                        <?php }
                                            ...
                                            <div class="advserch-field">
                                                <button type="submit" class="advsrch-act-btn"<?php echo ($button_style) ?>><i class="careerfy-icon careerfy-rockit-fill"></i> <?php esc_html_e("Looking for a dream job", 'careerfy-frame') ?></button>
                                            </div>
                                        </div>
                                        ...
                                        if (!empty($top_sectors) && !is_wp_error($top_sectors)) {
                                            ?>
                                            <ul class="careerfy-search-twentyone-list">
                                                <li<?php echo($adv_search_paragraph_color) ?>><?php esc_html_e('Top Industries:', 'careerfy-frame') ?></li>
                                                <?php
