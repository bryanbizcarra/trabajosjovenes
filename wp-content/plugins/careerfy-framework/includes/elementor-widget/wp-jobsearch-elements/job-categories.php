...
class JobCategories extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'cats_view' => array('view1', 'view2', 'view3', 'view4', 'view5', 'view6', 'view7', 'view9', 'view10', 'view11', 'slider'),
                ],
        ...
        $this->add_control(
            'browse_all_btn',
            [
                'label' => __('Browse all Button', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'yes',
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
    ...
    protected function render()
    {
        ...
        if (class_exists('JobSearch_plugin')) {
            ...
            //var_dump($to_result_page);
            //var_dump(get_permalink($to_result_page));
            ...
            }  else if ($cats_view == 'view11') {
                $cats_class = 'careerfy-categories-grideleven';
                                ...
                                <ul>
                                    ...
                                    <ul class="jobsearch-sects-allcon<?php echo $cats_view != 'view4' ? $row_class : '' ?>">
                                        ...
                                        foreach ($get_db_terms as $term_id) {
                                            ...
                                            if (!empty($term_sector_child) && $num_cats_child > 0) {
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="cat-slide-item">
                                                        <a href="<?php echo($cat_goto_link) ?>">
                                                            ...
                                                            <strong><?php echo($term_sector->name) ?></strong>
                                                            <?php if ($sector_job_counts == 'yes') { ?>
                                                                <small id="responsive-sect-cat-item-<?php echo absint($term_id) ?>"
                                                                       class="jobsearchh-sect-childcount"
                                                                       data-id="<?php echo absint($term_id) ?>">0
                                                                </small>
                                                            <?php } ?>
            ...
            //
            if ($cats_view == 'view11' && $responsive_itms != '') {
                $rand_num = rand(100000, 999999);
                ?>
                <div class="careerfy-slidesects-list careerfy-categories-grideleven" id="cat-lists-<?php echo($rand_num) ?>">
                    <div class="slidesectors-slider-main jobsearch-sects-allcon swiper-container">
                        <div class="swiper-wrapper">
                            <?php echo ($responsive_itms) ?>
                        </div>
                    </div>
                    <script>
                        jQuery(document).ready(function () {
                            var swiper = new Swiper('#cat-lists-<?php echo($rand_num) ?> .slidesectors-slider-main', {
                                slidesPerView: 1,
                                spaceBetween: 10,
                                autoHeight: true,
                                autoplay: {
            ...
            if ($browse_all_btn != 'no' && $result_page > 0 && $cats_view != 'view3' && $cats_view != 'view4' && $cats_view != 'view5' && $cats_view != 'view7') {
                ob_start();
            ...
            if ($browse_all_btn != 'no' && $result_page > 0 && $cats_view == 'view5') {
                ob_start();
                ?>
