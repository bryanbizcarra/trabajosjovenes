...
class JobsListings extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'view-listing-10' => __('Style 10', 'careerfy-frame'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'dropdowns' => __('Dropdown', 'careerfy-frame'),
        ...
        $this->add_control(
            'job_typefilters_sortby',
            [
                'label' => __('Job Type Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Sectors Filter Collapse', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'no',
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
        ...
        $this->add_control(
            'job_filters_skill',
            [
                'label' => __('Skills', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'yes',
                'description' => __("Jobs searching filters 'Skills' switch.", "careerfy-frame"),
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
                    'no' => __('No', 'careerfy-frame'),
                ],
        ...
        $this->add_control(
            'job_skillfilters_sortby',
            [
                'label' => __('Skills Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
        ...
        $this->add_control(
            'job_filters_skill_collapse',
            [
                'label' => __('Skills Filter Collapse', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'no',
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
