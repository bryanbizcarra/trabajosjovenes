    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT2,
                'default' => 'yes',
                'description' => __("Candidates searching filters 'Location' switch.", "careerfy-frame"),
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
                    'no' => __('No', 'careerfy-frame'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT2,
                'default' => 'yes',
                'description' => __("Candidates searching filters 'Date Posted' switch.", "careerfy-frame"),
                'options' => [
                    'yes' => __('Yes', 'careerfy-frame'),
                    'no' => __('No', 'careerfy-frame'),
                ],
        ...
        $this->add_control(
            'candidate_sectorfilters_sortby',
            [
