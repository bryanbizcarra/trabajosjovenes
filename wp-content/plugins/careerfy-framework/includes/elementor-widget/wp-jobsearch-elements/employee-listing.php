...
class EmployeeListings extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'view-listing2' => __('Style 4', 'careerfy-frame'),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'promote_employers_only',
            [
                'label' => __('Promote Employers only', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'yes',
                'description' => __("Display promote Employers only in listing.", "careerfy-frame"),
                'options' => [
        ...
        $this->add_control(
            'employer_locfilters_sortby',
            [
                'label' => __('Locations Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
        ...
        $this->add_control(
            'employer_datefilters_sortby',
            [
                'label' => __('Date Posted Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
        ...
        $this->add_control(
            'employer_sectorfilters_sortby',
            [
                'label' => __('Sectors Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
        ...
        $this->add_control(
            'employer_teamfilters_sortby',
            [
                'label' => __('Team Size Filters Sort by', 'careerfy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'default',
                'description' => '',
                'options' => [
...
// if no result found in filtration
    ...
    public function jobsearch_employers_content($employer_arg = '')
    {
        ...
        $promote_employers_only = isset($atts['promote_employers_only']) ? $atts['promote_employers_only'] : '';
...
// Element fields in filter
        ...
        if ($promote_employers_only == 'yes') {
            $element_filter_arr[] = array(
                'relation' => 'OR',
                array(
                    'key' => 'promote_profile_substime',
                    'value' => 0,
                    'compare' => '>',
                ),
                array(
                    'key' => '_feature_mber_frmadmin',
                    'value' => 'yes',
                    'compare' => '=',
                ),
            );
...
//
        ...
        <form autocomplete="off" id="jobsearch_employer_frm_<?php echo absint($employer_short_counter); ?>">
            ...
            if ($emp_top_search == 'yes') {
                ...
                if ($employer_view == 'view-listing2') {
                    ?>
                    <div class="careerfy-main-section careerfy-search-twentyone-full careerfy-listin-tsrch jobsearch-top-searchbar jobsearch-typo-wrap <?php echo ($search_main_class) ?> <?php echo ($adv_search_on) ?>">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="careerfy-search-twentyone">
                                    <div class="careerfy-search-twentyone-grid">
                                        ...
                                        <div class="advserch-field">
                                            ...
                                            <button type="submit" class="advsrch-act-btn"><i class="careerfy-icon careerfy-rockit-fill"></i> <?php esc_html_e("Looking for companies", 'careerfy-frame') ?></button>
                                        </div>
                                    </div>
                                    <?php
                                    if ($top_serch_style == 'advance') {
...
// custom field array for filteration from custom field module
    ...
    public function edit_orderby($orderby_statement, $wp_query)
    {
        ...
        $orderby_statement = "cast(postmeta.meta_value as unsigned) DESC, ID {$order}";
