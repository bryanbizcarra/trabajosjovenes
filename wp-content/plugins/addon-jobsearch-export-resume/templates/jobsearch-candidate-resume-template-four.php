                            ...
                            <div class="pdf-style5-bar-services-list">
                                ...
                                <div class="pdf-style5-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style5-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                ...
                <div class="pdf-style5-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style5-experience-inner <?php echo ($length == $x) ? 'last' : '' ?>">
                            <div class="pdf-style5-experience">
                            ...
                            <?php } else { ?>
                                <div class="pdf-style5-experience-sub"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '') ?>
                                    <span>/ &nbsp; &nbsp; <?php echo($experience_end_companyfield_val) ?></span></div>
                            <?php } ?>
                            <div class="pdf-style5-experience-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                        </div>
                        <?php
                        $x++;
                        $exfield_counter++;
                ...
                <div class="pdf-style5-education-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style5-education-inner">
                            <div class="pdf-style5-education">
                                <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                            </div>
