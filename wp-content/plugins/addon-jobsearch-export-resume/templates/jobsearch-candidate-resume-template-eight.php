                            ...
                            <div class="pdf-style9-bar-services-list">
                                ...
                                <div class="pdf-style9-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style9-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) {
                ...
                <div class="pdf-style9-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style9-experience-list-inn">
                            <div class="pdf-style9-experience">
                            ...
                            ?>
                            <div class="pdf-style9-experience-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                        </div>
                        <?php
                        $exfield_counter++;
                        $x++;
