                        ...
                        <div class="pdf-style20-left-bar">
                            ...
                            <div class="pdf-style20-bar-info">
                                <div class="pdf-style20-bar-info-icon"><img
                                            ...
                                            alt=""></div>
                                <div class="pdf-style20-bar-info-text"><?php echo($candidate_address) ?></div>
                            </div>
                            <br>
                            <!--Candidate Skills-->
                            ...
                            <div class="pdf-style20-bar-services-list">
                                ...
                                <div class="pdf-style20-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style20-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) { ?>
                ...
                <div class="pdf-style20-experience-list">
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        <div class="pdf-style20-experience-inner">
                            <div class="pdf-style20-experience">
                            ...
                            <div class="pdf-style20-experience-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                        </div>
                        <?php
                        $exfield_counter++;
                        $x++;
