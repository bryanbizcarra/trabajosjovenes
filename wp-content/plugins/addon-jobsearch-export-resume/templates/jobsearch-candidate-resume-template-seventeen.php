                        ...
                        <?php } else { ?>
                            ...
                            <div class="pdf-style18-bar-services-list">
                                ...
                                <div class="pdf-style18-bar-services-text">
                                    <div class="pdf-style18-bar-services-title"><?php echo stripslashes($info['label']) ?></div>
                                    <?php
                                    if (isset($info['options']['value'])) {
                                        $field_put_val = jobsearch_custom_fields_options_slugtolabel($field_value, $info);
                                        ?>
                                        <div class="pdf-style18-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) {  ?>
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        <div class="pdf-style18-content-list-inner <?php echo ($x === $length) ? 'last' : '' ?>">
                            ...
                            <div class="pdf-style18-content-list-text">
                                ...
                                <div class="pdf-style18-content-list-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
