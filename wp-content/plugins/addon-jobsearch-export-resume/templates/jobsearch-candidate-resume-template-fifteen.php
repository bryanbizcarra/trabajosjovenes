                            ...
                            <div class="pdf-style16-social-list">
                                ...
                                <?php if ($user_twitter_url != '' && $cand_alow_twt_smm == 'on') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        ...
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><a href="<?php echo jobsearch_esc_html(esc_url($user_twitter_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_twitter_url)) ?></a>
                                            </div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('Twitter Profile', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($user_linkedin_url != '' && $cand_alow_linkd_smm == 'on') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon">
                                            <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/linkedin16.png') ?>">
                                        </div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><a href="<?php echo jobsearch_esc_html(esc_url($user_linkedin_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_linkedin_url)) ?></a>
                                            </div>
                                ...
                                <?php if ($cand_email != '') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon"><img
                                                    ...
                                                    alt=""></div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><?php echo ($cand_email) ?></div>
                                ...
                                <?php if ($phone_number != '') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        ...
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><?php echo ($phone_number) ?></div>
...
//                readfile($file_name);
                        ...
                        <?php } else { ?>
                            <div class="pdf-style16-bar-services-list">
                                ...
                                <div class="pdf-style16-bar-services-text">
                                    <div class="pdf-style16-bar-services-title"><?php echo stripslashes($info['label']) ?></div>
                                    <?php
                                    if (isset($info['options']['value'])) {
                                        $field_put_val = jobsearch_custom_fields_options_slugtolabel($field_value, $info);
                                        ?>
                                        <div class="pdf-style16-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) { ?>
                        ...
                        foreach ($exfield_list as $exfield) {
                            ...
                            <div class="pdf-style16-experience-list-inn">
                                ...
                                <div class="pdf-style16-experience-list-text">
                                    ...
                                    <div class="pdf-style16-experience-list-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                                </div>
                            </div>
                            <?php
                            $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style16-experience-list">
