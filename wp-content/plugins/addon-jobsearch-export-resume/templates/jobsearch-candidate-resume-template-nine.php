            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_nine'])) {
                ...
                <div class="pdf-style10-left-bar">
                    ...
                    <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Dribbble:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">
                    ...
                    <?php if ($user_youtube_url != '') { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Youtube:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">
                        ...
                        <?php } else { ?>
                            <div class="pdf-style10-bar-services-list">
                                ...
                                <div class="pdf-style10-bar-services-text">
                                    <div class="pdf-style10-bar-services-title"><?php echo stripslashes($info['label']) ?></div>
                                    <?php 
                                    if (isset($info['options']['value'])) {
                                        $field_put_val = jobsearch_custom_fields_options_slugtolabel($field_value, $info);
                                        ?>
                                        <div class="pdf-style10-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) { ?>
                ...
                <div class="pdf-style10-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style10-experience-inner">
                            <div class="pdf-style10-experience">
                            ...
                            <?php } ?>
                            <div class="pdf-style10-experience-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                        </div>
