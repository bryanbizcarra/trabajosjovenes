                            ...
                            <div class="pdf-style11-bar-services-list">
                                ...
                                <div class="pdf-style11-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style11-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style11-content-list-inn <?php echo ($x == $length) ? 'last' : '' ?>">
                            ...
                            <div class="pdf-style11-content-list-inn-left">
                                ...
                                <?php } ?>
                                <div class="pdf-style11-content-list-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
