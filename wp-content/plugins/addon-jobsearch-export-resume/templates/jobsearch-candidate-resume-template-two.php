                            ...
                            <div class="pdf-style4-bar-services-list">
                                ...
                                <div class="pdf-style4-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style4-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) { ?>
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style4-experiences-inner">
                            ...
                            <div class="pdf-style4-experiences-text">
                                ...
                                <div class="pdf-style4-experiences-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                            </div>
                        </div>
                ...
                foreach ($exfield_list as $exfield) {
                    ...
                    <div class="pdf-style4-skills">
                        ...
                        <div class="pdf-style4-skills-line">
                            ...
                            <div class="pdf-style4-skills-inn1 pdf-style4-skills-inn2"
