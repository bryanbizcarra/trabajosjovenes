                            ...
                            <div class="pdf-style17-bar-services-list">
                                ...
                                <div class="pdf-style17-bar-services-text">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style17-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                ...
                <div class="pdf-style17-content-list">
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        <div class="pdf-style17-content-list-inner <?php echo ($key == 0) ? 'first' : '' ?> <?php echo ($x === $length) ? 'last' : '' ?>">
                            <div class="pdf-style17-content-list" style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/circle20.png') ?>');">
                                <div></div>
                            </div>
                            ...
                            <div class="pdf-style17-content-list-text">
                                ...
                                <div class="pdf-style17-content-list-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                            </div>
                        </div>
