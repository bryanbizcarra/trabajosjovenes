                        ...
                        if (!empty($info['name'])) {
                            ...
                            <div class="pdf-style14-bar-services-list">
                                ...
                                <div class="pdf-style14-bar-services-text">
                                    <div class="pdf-style14-bar-services-title"><?php echo stripslashes($info['label']) ?></div>
                                    <?php 
                                    if (isset($info['options']['value'])) {
                                        $field_put_val = jobsearch_custom_fields_options_slugtolabel($field_value, $info);
                                        ?>
                                        <div class="pdf-style14-bar-services-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style15-content-list-inn">
                                ...
                                <div class="pdf-style15-content-list-text">
                                    ...
                                    <div class="pdf-style15-content-list-pera"><?php echo jobsearch_esc_wp_editor($exfield_val) ?></div>
                                </div>
                            </div>
