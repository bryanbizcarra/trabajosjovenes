    ...
    class jobsearch_candidate_pdf_resume_template_one
    {
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_one'])) {
                ...
                $user_obj = get_user_by('ID', $user_id);
                $cand_email = isset($user_obj->user_email) ? $user_obj->user_email : '';
                $user_firstname = isset($user_obj->first_name) && $user_obj->first_name != '' ? $user_obj->first_name : 'user';
                $user_displayname = isset($user_obj->display_name) ? $user_obj->display_name : '';
                //
                        ...
                        <?php } else { ?>
                                ...
                                <div class="pdf-style2-about-list-col">
                                    ...
                                    if (isset($info['options']['value'])) {
                                        ...
                                        ?>
                                        <div class="pdf-style2-about-sub"><?php echo ($field_put_val) ?></div>
                                        <?php
                                    } else {
                                        if (is_array($field_value) && count($field_value) > 0) {
                                            foreach ($field_value as $val) { ?>
                    ...
                    <div class="pdf-style2-education-list">
                        <div class="pdf-style2-education-inner last-list">
                            ...
                            <div class="pdf-style2-education-col2">
                                <?php echo jobsearch_esc_wp_editor($exfield_val) ?>
                            </div>
                        </div>
                    </div>
                    <?php $exfield_counter++;
                ...
                foreach ($exfield_list as $exfield) {
                    ...
                    <div class="pdf-style2-skills">
                        ...
                        <div class="pdf-style2-skills-line">
                            <div class="pdf-style2-skills-inn1"><?php echo absint($skill_percentagefield_val) ?>%</div>
<!--                            <div class="pdf-style2-skills-inn1" style="width: <?php echo absint($lang_percentagefield_val) ?>%;"></div>-->
                        </div>
                    </div>
                    <?php $exfield_counter++;
                }
                ...
                foreach ($exfield_list as $exfield) {
                    ...
                    <div class="pdf-style2-skills">
                        <div class="pdf-style2-skills-left">
                            <strong><?php echo($exfield) ?></strong></div>
                        <div class="pdf-style2-skills-line">
                            <div class="pdf-style2-skills-inn1"><?php echo($lang_level_str) ?> <?php echo absint($lang_percentagefield_val) ?>%</div>
<!--                            <div class="pdf-style2-skills-inn1" style="width: <?php echo absint($lang_percentagefield_val) ?>%;"></div>-->
                        </div>
                    </div>
                    <?php $exfield_counter++;
