            ...
            if ($meetings_view == 'calendar') {
                    ...
                    add_action('wp_footer', function() use ($meetins_posts, $meets_footr_args) {
                        ...
                        foreach ($meetins_posts as $meet_post_id) {
                            ...
                            $meet_exct_stime = $meet_exct_stime > 0 ? $meet_exct_stime-60 : $meet_exct_stime;
                            $meet_exct_entime = $meet_exct_entime > 0 ? $meet_exct_entime+60 : $meet_exct_entime;
                                        ...
                                        <div class="meetin-belowbtns-con">
                                            <div class="meetin-reschedbtn-con">
                                                <div class="meetin-belowbtn-iner">
                                                    <a href="javascript:void(0);" class="jobsearch-meet-reschedulepop" data-id="<?php echo ($meet_job_id) ?>" data-cd="<?php echo ($meetin_emp_id) ?>" data-md="<?php echo ($meet_post_id) ?>"><i class="fa fa-calendar"></i> <?php esc_html_e('Re-schedule Meeting', 'jobsearch-shmeets') ?></a>
                                                </div>
                                            </div>
                    ...
                    <div class="jobsearch-interview-list-container">
                        ...
                        foreach ($meetins_posts as $meet_post_id) {
                            ...
                            if ($meet_date < $current_date) {
                                $meet_day = date_i18n('l', $meet_date);
                            }
                            if ($very_first_meet) {
