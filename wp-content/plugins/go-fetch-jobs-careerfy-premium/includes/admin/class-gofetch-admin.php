...
class GoFetch_Admin {
	...
	public function enqueue_admin_scripts( $hook ) {
		...
		$params = array(
			...
			'msg_import_jobs'       => __( 'Jobs are being fetched and imported, please wait. This can take some time depending on your options and number of jobs being imported...' , 'goftech-wpjm' ),
