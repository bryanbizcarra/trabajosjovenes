...
/**
 * Plugin Name: Go Fetch Jobs (for Careerfy) (Premium)
 * Version:     1.2.0
 * Update URI: https://api.freemius.com
 * Description: Instantly populate your Careerfy database using RSS job feeds from the most popular job sites.
...
if ( function_exists( 'gfjwjm_fs' ) ) {
    gfjwjm_fs()->set_basename( true, __FILE__ );
} else {
    // Begin Freemius.
    ...
    if ( !function_exists( 'gfjwjm_fs' ) ) {
        ...
        function gfjwjm_fs()
        {
            ...
            if ( !isset( $gfjwjm_fs ) ) {
                ...
                if ( !defined( 'WP_FS__PRODUCT_8085_MULTISITE' ) ) {
                    define( 'WP_FS__PRODUCT_8085_MULTISITE', true );
                }
                // Include Freemius SDK.
                require_once dirname( __FILE__ ) . '/includes/freemius/start.php';
                $gfjwjm_fs = fs_dynamic_init( array(
                    'id'         => '8085',
                    'slug'       => 'go-fetch-jobs-careerfy',
                    'public_key' => 'pk_bdc93f6dd49f98e76295251f58f59',
                    'menu'       => array(
                    'slug'    => 'go-fetch-jobs-careerfy',
                    'support' => false,
                ),
        ...
        if ( !class_exists( 'GoFetch_Jobs' ) ) {
            ...
            final class GoFetch_Jobs
            {
                 ...
                 */
                protected static  $module = 'careerfy' ;
                /**
                 ...
                 */
                public  $parent_plugin = 'Careerfy' ;
                /**
                 * @var The expected parent plugin/theme ID.
                 */
                public  $parent_plugin_id = 'Careerfy_framework' ;
                /**
                 ...
                 * @var The plugin slug.
                 */
                public  $slug = 'go-fetch-jobs-careerfy' ;
                /**
                ...
                public function __construct()
                {
                    ...
                    $this->init_hooks();
                    do_action( "gofetch_{$module}_loaded" );
                }
                ...
                public function includes()
                {
                    ...
                    if ( gfjwjm_fs()->is__premium_only() ) {
                        require_once 'includes/premium/load__premium_only.php';
                    }
                ...
                public function init()
                {
                    ...
                    // Before init action.
                    do_action( "before_gofetch_{$module}_init" );
                    // Set up localization.
                    $this->load_plugin_textdomain();
                    // Init action.
                    do_action( "gofetch_{$module}_init" );
                }
                ...
                {
                    $module = self::$module;
                    add_option( "goft-{$module}-activated", 1 );
                }
                ...
                public function maybe_install()
                {
                    ...
                    if ( !class_exists( $this->parent_plugin_id ) ) {
                    ...
                    if ( !is_admin() || get_option( "goft-{$module}-samples-installed" ) || !get_option( "goft-{$module}-activated" ) ) {
                        return;
                    }
                    add_option( "goft-{$module}-samples-installed", 1 );
                    delete_option( "goft-{$module}-activated" );
