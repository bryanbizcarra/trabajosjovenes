        ...
        <ul class="row">
            ...
            foreach ($featjobs_posts as $fjobs_post) {
                ...
                <li class="<?php echo esc_html($columns_class); ?>">
                    <div class="careerfy-jobs-wrapper-style9<?php echo apply_filters('jobsearch_jobs_list_mainwrap_classes', '', $job_id, 'grid4') ?>">
                        <div class="careerfy-jobs-box1">
                            ...
                            echo apply_filters('jobsearch_job_listingitm_publish_date_html', $publishdte_html, $job_id, $job_post_date, 'grid-4');
                            ?>
                        ...
                        <div class="careerfy-jobs-box2">
                            ...
                            <?php 
                            $job_img_output = ob_get_clean();
                            echo apply_filters('jobsearch_job_list_imgthumb_html', $job_img_output, $job_id, 'grid4');
