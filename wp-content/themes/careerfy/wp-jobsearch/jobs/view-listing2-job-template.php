        ...
        <ul class="row">
            ...
            foreach ($featjobs_posts as $fjobs_post) {
                ...
                <li class="<?php echo($columns_class); ?>">
                    ...
                    <div class="careerfy-joblisting-plain-wrap<?php echo apply_filters('jobsearch_jobs_list_mainwrap_classes', '', $job_id, 'listing2') ?>">
                        <?php
                        ...
                        echo apply_filters('jobsearch_job_list_imgthumb_html', $job_img_output, $job_id, 'listing2');
                        ?>
                        <div class="careerfy-joblisting-plain-text">
                            <div class="careerfy-joblisting-plain-left">
                                ...
                                <ul>
                                    ...
                                    if ($job_salary != '') { ?>
                                        <li>
                                            <i class="careerfy-icon careerfy-money"></i> <?php echo jobsearch_esc_html($job_salary) ?>
                                        </li>
                                    <?php } ?>
                                </ul>
                                <?php
